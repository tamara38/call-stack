...
tree, printing the tree as well as deleting the three from a memory. Added the ability to convert the 
tree into a graph and display it using an adjacency list and BFS algorithm. Recursive function calls in 
the call stack can be detected as well, by identifying cycles in the graph.  
